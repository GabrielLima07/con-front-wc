...
const CustomerPerfil = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Tente obter o cliente da sessionStorage
        ...
        if (selectedCustomer) {
          ...
          setTickets(selectedCustomer.tickets); // Verifique se os tickets estão disponíveis
        } else {
          // Se não houver cliente selecionado, busque os dados pela API
    ...
    fetchData();
  }, [customerId]); // O efeito depende do customerId
