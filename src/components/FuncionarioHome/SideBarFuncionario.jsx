...
const SideBarFuncionario = () => {
  ...
  return (
    <div className="flex flex-col h-full sm:h-full border-r border-[#379E53] sm:border-r sm:border-[#379E53] lg:h-full lg:border-r lg:border-[#379E53] bg-begepalido">
      {isLoading ? (
        <Loading />
      ) : (
        <div>
          {/* department name */}
          <section>
            <h3 className="flex justify-center text-md md:text-lg py-1 px-4 text-center">
          ...
          <div className="flex flex-col">
            {/* department tickets situation */}
            <section className="px-2 lg:px-4 py-2">
              <h3 className="text-[#0e0e0e73] text-sm md:text-sm lg:text-base">
                Situações dos Tickets
              </h3>
              <div className="flex flex-col gap-1 text-xs md:text-sm lg:text-base">
                <h3 className="text-inherit">Abertos: {abertos}</h3>
                <h3 className="text-inherit">Em atendimento: {emAtendimento}</h3>
                <h3 className="text-inherit">Em impedimento: {emImpedimento}</h3>
                <h3 className="text-inherit">Fechados: {fechados}</h3>
              </div>
            </section>
